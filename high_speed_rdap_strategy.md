...
ہم نے اس ناممکن کام کو دو حصوں میں تقسیم کیا:

### پہلا مرحلہ: سٹریمنگ فلٹر (Streaming Filter)
ہمیں معلوم تھا کہ ساڑھے چار لاکھ ڈومینز کو ایک ایک کر کے لائیو چیک کرنا بے وقوفی ہے۔ اس لیے ہم نے سب سے پہلے Hugging Face سے 2025 کا رجسٹرڈ ڈومینز کا ڈیٹا بیس (8.6 GB) لیا۔ اسے ڈاؤن لوڈ کر کے ہارڈ ڈسک میں سیو کرنے کے بجائے ہم نے لینکس کی `curl` اور `grep` کمانڈ کے ذریعے اسے ہوا میں ہی (in-memory) فلٹر کیا۔ 
اس ایک سمارٹ حرکت سے ہم نے فوراً 4 لاکھ ڈومینز کو لسٹ سے اڑا دیا کیونکہ وہ پہلے ہی رجسٹرڈ تھے۔

### دوسرا مرحلہ: Asynchronous لائیو چیکنگ (Asyncio + Aiohttp)
بقیہ 60 ہزار (اور بعد میں مزید 4 لاکھ) ڈومینز کو لائیو چیک کرنے کے لیے ہم نے عام (Synchronous) طریقے کے بجائے **Asynchronous** طریقہ استعمال کیا۔ 
...
1. **ڈیٹا فلٹرنگ (Pre-Filtering):** کسی بھی بڑے کام کو کرنے سے پہلے اگر ہم پہلے سے موجود ڈیٹا سے چھانٹی کر لیں تو 90 فیصد کام ویسے ہی کم ہو جاتا ہے۔
2. **Asynchronous Execution:** نیٹ ورک کے کاموں (Network I/O) کے لیے `asyncio` کا استعمال روایتی سکرپٹس کے مقابلے میں 100 گنا تیز ہوتا ہے۔
3. **ہوشمند رفتار (Smart Concurrency):** بہت زیادہ سپیڈ (جیسے 1000 ریکویسٹس فی سیکنڈ) آپ کو مستقل بلاک کروا سکتی ہے۔ درمیانی رفتار (50 ریکویسٹس فی سیکنڈ) نے ہمارے کام کو محفوظ اور لگاتار چلنے کے قابل بنایا۔
